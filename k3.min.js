...
import "https://cdn.jsdelivr.net/gh/nodeca/pako@master/dist/pako.js";const k3={isValidZlib:function(i){let t=atob(i).split("").map((i)=>i.charCodeAt(0)),e=new Uint8Array(t);try{return pako.inflate(e),!0}catch{return!1}},isValidB84:function(i){return[...i].every((i)=>"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!$%&+-.=?^{}/#_*':,@~|".includes(i))},isValidK3:function(i){let t=i.split(";");return(i.startsWith("K3")&&";:".includes(i[2])&&t.length>=5&&this.isValidB84(t[1])&&this.isValidB84(t[2])&&this.isValidB84(t[3])&&t[3].length===1&&this.isValidZlib(t[4]))},};window.k3=k3