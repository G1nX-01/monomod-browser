...
import "https://cdn.jsdelivr.net/gh/nodeca/pako@master/dist/pako.js";let k3=(function(){function isValidZlib(i){let t=atob(i).split("").map((i)=>i.charCodeAt(0)),e=new Uint8Array(t);try{return pako.inflate(e),!0}catch{return!1}}
let BASE84="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!$%&+-.=?^{}/#_*':,@~|";function isValidB84(i){return[...i].every((i)=>"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ!$%&+-.=?^{}/#_*':,@~|".includes(i))}
function isValidK3(i){let t=i.split(";");return i.startsWith("K3")&&";:".includes(i[2])&&t.length>=5&&isValidB84(t[1])&&isValidB84(t[2])&&isValidB84(t[3])&&1===t[3].length&&isValidZlib(t[4])}
return{isValidK3,isValidB84,isValidZlib}})()